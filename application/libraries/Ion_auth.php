...
class Ion_auth
{
	...
	/*public function register_seller($identity, $password, $email, $additional_data = array(), $group_ids = array())
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');
	...
	/*public function seller_logged_in()
	{
		...
		$recheck = $this->ion_auth_model->seller_recheck_session();

		// auto-login the user if they are remembered
		if (!$recheck && get_cookie($this->config->item('identity_cookie_name', 'ion_auth')) && get_cookie($this->config->item('remember_cookie_name', 'ion_auth')))
		{
			$recheck = $this->ion_auth_model->seller_login_remembered_user();
		}
