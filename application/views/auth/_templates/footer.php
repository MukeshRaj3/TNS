            ...
            <div class="container">
                <div class="row copyright">
                    <div class="col-md-12 col-lg-6 ttm-footer2-left">
                        <span>Copyright © 2022 <a href="#">Vamonosprint</a></span>
                    </div>
...
<!-- <div class="wrap-modal1 js-modal1">
   ...
   <script src="<?php echo base_url($assets_dir); ?>js/jquery.min.js"></script>
    ...
    <?php
    if ($this->router->fetch_method() == 'plan'): ?>
        <script>
                window.onload = function (e) {
                    var full_url = document.URL; 
                    var url_array = full_url.split('#') 
                    var last_segment = url_array[url_array.length - 1]; 
                    if (last_segment == "first") {

                        document.getElementById("first").style.display = "flex";
                        document.getElementById("second").style.display = "none";
                        document.getElementById("third").style.display = "none";
                    }
                    else if (last_segment == "second") {

                        document.getElementById("second").style.display = "flex";
                        document.getElementById("first").style.display = "none";
                        document.getElementById("third").style.display = "none";
                    }
                    else if (last_segment == "third") {
