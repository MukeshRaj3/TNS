<div class="sidebar col-lg-1">
                ...
                <div class="sidenav-options">
                    ...
                    <a href="<?php echo base_url('seller/seller/transaction_report'); ?>"><img src="<?php echo base_url(); ?>assets/images/sidebar/folder_shared.png" alt=""></a>
                    <a href="<?php echo base_url('seller/seller/order_report'); ?>"><img src="<?php echo base_url(); ?>assets/images/sidebar/folder_shared.png" alt=""></a>
