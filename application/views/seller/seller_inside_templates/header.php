...
<body>
    <header>
        <nav class="navbar navbar-expand-lg" style=" background-color: #2457aa;">
            <div class="container-fluid main-nav">
                <a class="navbar-brand logo" href="#"><img src="<?php echo base_url(); ?>assets/images/Group 1.png" alt=""></a>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                <i class="fa fa-user" style="color: white; font-size: 1.3rem;"></i><br><span
