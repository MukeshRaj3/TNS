                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-2 widget-area m-auto">
                        <div class="widget">
                            <div class="footer-logo">
                                <img id="footer-logo-img" class="img-center" src="<?php echo base_url(); ?>images/logo.png" alt="" width="150">
                                <!-- <h4>The Nirman Store</h4> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 widget-area">
                        <div class="widget widget_text ml-40">
                            <ul class="widget_info_text">
                                <li><i class="fa fa-map-marker"></i><strong>Our Main Branch</strong> <br> Hydrabad
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 widget-area">
                        <div class="widget contact_map clearfix">
                            ...
                            <div class="footer_map mb-30 mt-5">
                                <img src="<?php echo base_url(); ?>images/footer_map.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row copyright">
                    <div class="col-md-12 col-lg-6 ttm-footer2-left">
                        <span>Copyright © 2022 <a href="#"><?php echo $site_title; ?></a></span>
                    </div>
                    <div class="col-md-12 col-lg-6 ttm-footer2-right">
                        <div class="supported_card-block">
                            <ul>
                                <li><img src="<?php echo base_url(); ?>images/supported_card/card-1.png" alt="maestro"></li>
                                <li><img src="<?php echo base_url(); ?>images/supported_card/card-2.png" alt="paypal"></li>
                                <li><img src="<?php echo base_url(); ?>images/supported_card/card-3.png" alt="western union"></li>
                                <li><img src="<?php echo base_url(); ?>images/supported_card/card-4.png" alt="visa"></li>
                                <li><img src="<?php echo base_url(); ?>images/supported_card/card-5.png" alt="cirrus"></li>
                                <li><img src="<?php echo base_url(); ?>images/supported_card/card-6.png" alt="ebay"></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="summary entry-summary pl-30 res-991-pl-0 res-991-pt-40">
                        ...
                        <div class="comments-notes clearfix">
                            &nbsp;&nbsp;<a href="javascript:void(0)" class="review-link" rel="nofollow">(No
                                review)</a>
                            &nbsp;&nbsp;<a href="javascript:void(0)" class="review-link" rel="nofollow">Write to
                                Review</a>
                        ...
                        <div class="product_in-stock"><i class="fa fa-check-circle"></i><span> in Stock Only 14
                                left</span>
                        </div>
                        <span class="price">
                        ...
                        <div class="product-details__short-description">Raising a heavy fur muff that covered
                            the whole of her lower arm towards the viewer regor then turned to look out the
                            window
                        </div>
