...
class Party extends Seller_Controller {

  public function __construct() {
      parent::__construct();

      /* Load :: Common */
      $this->load->model('seller/party_model');
  }
  ...
  public function index() {
    ...
    /* Load Template */
    $this->template->seller_render('seller/party/index', $this->data);
  }
  ...
  public function create() {
    ...
    if ($this->form_validation->run() == TRUE) {
      ...
      if ($check) {
        ...
        redirect('seller/party/create', 'refresh');
      }
