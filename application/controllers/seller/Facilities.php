...
class Facilities extends Seller_Controller {

    public function __construct() {
      parent::__construct();

      /* Load :: Language */
      $this->lang->load('seller/facilities');
      /* Load :: Common */
      $this->load->model('seller/facilities_model');
    ...
    public function index() {
        ...
        /* Load Template */
        $this->template->admin_render('seller/facilities/index', $this->data);
    }
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!empty($_FILES['facility_icon']['name'])) {
                ...
                if ($this->upload->do_upload('facility_icon')) {
                    ...
                    redirect('seller/facilities/create', 'refresh');
                }
            }else{
            ...
            if ($create) {
                ...
                redirect('seller/facilities', 'refresh');
            } else {
            ...
            /* Load Template */
            $this->template->admin_render('seller/facilities/create', $this->data);
        }
    }
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            if (!empty($_FILES['facility_icon']['name'])) {
                ...
                if ($this->upload->do_upload('facility_icon')) {
                    ...
                    $this->session->set_flashdata('message', array('0',$this->upload->display_errors()));
                    redirect('seller/facilities/edit', 'refresh');
                }
            }else{
            ...
            /* Load Template */
            $this->template->admin_render('seller/facilities/edit', $this->data);
        }
    }
}
